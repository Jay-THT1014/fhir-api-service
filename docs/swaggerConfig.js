            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  sourceId: {
                    type: "string",
                    description: "The unique ID of the Encounter in the source EHR system",
                    example: "123",
                  },
                  sourceSystem: { type: "string", example: "localhost:8103" },
                  operation: {
                  ...
                  class_code: { type: "string", example: "AMB" },
                  class_display: { type: "string", example: "ambulatory" },
                  type_code: { type: "string", example: "99213" },
                  type_display: { type: "string", example: "Office or other outpatient visit" },
                  reason_code: { type: "string", example: "J01.90" },
                  reason_display: { type: "string", example: "Acute sinusitis, unspecified" },
                  discharge_disposition_code: { type: "string", example: "01" },
                  discharge_disposition_display: { type: "string", example: "Discharged to home care" },
                ...
                required: ["sourceId", "status", "patient_id"],
              },
            },
          },
        },
