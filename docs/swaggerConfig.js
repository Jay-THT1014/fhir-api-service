            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  sourceId: {
                    type: "string",
                    description: "The unique ID of the Patient in the source EHR system (optional)",
                    example: "123456",
                  },
                  sourceSystem: {
                    type: "string",
                    example: "localhost:8103",
                  },
                  orgId: {
                    type: "string",
                    example: "452",
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  sourceId: {
                    type: "string",
                    description: "The unique ID of the Practitioner in the source EHR system (optional)",
                    example: "123",
                  },
                  sourceSystem: { type: "string", example: "localhost:8103" },
                  operation: {
                  ...
                  use: { type: "string", example: "work" },
                  address: { type: "string", description: "Street address line", example: "123 Medical Dr" },
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  sourceId: {
                    type: "string",
                    description: "The unique ID of the Organization in the source EHR system (optional)",
                    example: "123",
                  },
                  sourceSystem: { type: "string", example: "localhost:8103" },
                  operation: {
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  sourceId: {
                    type: "string",
                    description: "The unique ID of the Location in the source EHR system (optional)",
                    example: "123",
                  },
                  sourceSystem: { type: "string", example: "localhost:8103" },
                  operation: {
                  ...
                  use: { type: "string", example: "work" },
                  address: { type: "string", description: "Street address line", example: "789 Care Blvd" },
                  city: { type: "string", example: "Metropolis" },
                  state: { type: "string", example: "NY" },
